        ...
        <section className={styles.details}>
          <div className={styles.left}>
            ...
            <form>
              ...
              <input type='number' name='numero' value={formData.numero} onChange={handleChange} />
              ...
              <input type='number' name='rue' value={formData.rue} onChange={handleChange} />
              <label htmlFor='logt'>Logts</label>
              <input type='number' name='logt' value={formData.logt} onChange={handleChange} />
            </form>
          </div>
